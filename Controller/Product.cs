...
namespace TindaPress
{
    public class Product
    {
        #region Fields
        /// <summary>
        /// Instance of Product Class with activate, delete, insert, list, near me and update method.
        /// </summary>
        ...
        public async void Activate(string wp_id, string session_key, string pdid, Action<bool, string> callback)
        {
            ...
            var response = await client.PostAsync(TPHost.Instance.BaseDomain + "/tindapress/v1/products/activate", content);
        ...
        public async void Delete(string wp_id, string session_key, string pdid, Action<bool, string> callback)
        {
            ...
            var response = await client.PostAsync(TPHost.Instance.BaseDomain + "/tindapress/v1/products/delete", content);
            response.EnsureSuccessStatusCode();
                ...
                string sku, string price, string weight, string preview, string dimension, Action<bool, string> callback)
        {
            ...
            var response = await client.PostAsync(TPHost.Instance.BaseDomain + "/tindapress/v1/products/insert", content);
            response.EnsureSuccessStatusCode();
        ...
        #region List Method
        public async void List(string wp_id, string session_key, string stid, string catid, string pid, string status, Action<bool, string> callback)
        {
            var dict = new Dictionary<string, string>();
                dict.Add("wpid", wp_id);
                dict.Add("snky", session_key);
            ...
            var response = await client.PostAsync(TPHost.Instance.BaseDomain + "/tindapress/v1/products/list", content);
            response.EnsureSuccessStatusCode();
        ...
        public async void NearMe(string wp_id, string session_key, string lat, string lon, Action<bool, string> callback)
        {
            ...
            var response = await client.PostAsync(TPHost.Instance.BaseDomain + "/tindapress/v1/products/nearme", content);
            response.EnsureSuccessStatusCode();
                ...
                string long_info, string sku, string price, string weight, string preview, string dimension, Action<bool, string> callback)
        {
            ...
            var response = await client.PostAsync(TPHost.Instance.BaseDomain + "/tindapress/v1/products/update", content);
            response.EnsureSuccessStatusCode();
